...
- Owns: the adapter trait (locate / read / unlocate), envelope types (Source projection, three-state read Content / Gone / Error), composite dispatch (locate first-hit), and the test stub (MapAdapter).
