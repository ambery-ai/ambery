...
const zh = {
  ...
  "chat.setup-banner": "LLM 未配置，点击打开配置引导",
  "chat.llm-error-banner": "LLM 连接失败，点击打开配置",
  "chat.unconfigured-error": "LLM 未配置，无法发送（请先打开配置引导）",
...
const en: Record<keyof typeof zh, string> = {
  ...
  "chat.setup-banner": "LLM not configured — click to open the setup guide",
  "chat.llm-error-banner": "LLM connection failed — click to open config",
  "chat.unconfigured-error": "LLM not configured, cannot send (open the setup guide first)",
