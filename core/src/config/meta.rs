...
pub static NODES: &[NodeMeta] = &[
    ...
    NodeMeta { path: "timer_interval_ms", kind: NodeKind::Leaf, validate: V, no_llm_visible: false, cold: true },
    NodeMeta { path: "timer_stagger_ms", kind: NodeKind::Leaf, validate: V, no_llm_visible: false, cold: true },
    NodeMeta { path: "timer_tick_ms", kind: NodeKind::Leaf, validate: V, no_llm_visible: false, cold: false },
    NodeMeta { path: "timer_batch", kind: NodeKind::Leaf, validate: V, no_llm_visible: false, cold: false },
