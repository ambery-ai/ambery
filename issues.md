...
## #3 界面主题单一，缺少可配置的亮色模式 (2026-07-27) — deferred (后续独立PR)
...
## #7 聊天需要流式输出，thinking 只显示透明气泡 (2026-07-27) — deferred (需LLM streaming端支持)
...
## #8 Card 和 Chat panel 窗口应当支持独立拖动 (2026-07-27) — deferred (需布局引擎改造)
